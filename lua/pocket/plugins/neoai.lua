    ...
    neoai.setup {
      ...
      prompts = {
        ...
        context_prompt = function(context)
          return table.concat({
            "Hey, I'd like to provide some context for future messages.",
            'Here is the code/text that I want to refer to in our upcoming conversations:\n\n',
            context,
          }, ' ')
        end,
      },
      ...
      open_ai = {
        api_key = {
          env = 'OPENAI_API_KEY',
          value = nil,
          -- `get` is a function that retrieves an API key, can be used to override the default method.
          -- get = function() ... end
      ...
      --     prompt = function()
      --       return table.concat({
      --         'Using the following git diff generate a concise and clear git commit message,',
      --         'with a short title summary that is 75 characters or less:\n',
